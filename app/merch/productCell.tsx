    ...
    return <Link props={{
        ...
        child: <>
            <Image props={{
                ...
                imgClass: "rounded-t-lg overflow-hidden group-hover:scale-105 transition-all max-h-[500px]"
            }} />
            <div className="px-5 pb-5 pt-2 mw-auto border-t border-t-bg-500 bg-bg-700 rounded-b-md">
                <h5 className="text-2xl font-semibold tracking-tight text-white group-hover:opacity-75 transition-opacity">{product.title}</h5>
                <p className="text-gray-400 group-hover:opacity-75 transition-opacity pb-2">{product.description}</p>
